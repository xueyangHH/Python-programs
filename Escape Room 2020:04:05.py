...
def bedroom():
    ...
    if safe_opened == False:
        ...
        while false_tries < 5:
            ...
            if (choice in ['open','safe','unlock']) and (safe_opened == False):
                trying = 'y'
                while trying == 'y':
            ...
            elif (choice in ['open','safe','unlock']) and (safe_opened == True):
                if key_taken == True:
                    print("The safe is already open and you have the key!")
                else:
            ...
            elif choice in ['north','main room','up','upstairs','back']:
                return main_room
    ...
    # if it is not the first time they enter the room and the safe is open        
        ...
        while True:
            ...
            if choice == 'bed':
                print("I don't think the bed has anything to do with the game.")
            # they still want to see the safe
            elif choice in ['open','safe','unlock']:
                if key_taken == True:
                    print("The safe is already open and you have the key!")
                else:
                    take = str.lower(input('Do you want to take the key? (y/n) '))
...
def study():
    ...
    while True:
        ...
        # they don't know where they are
            ...
            print('You are already here.')
        # they want to go to the main room
        elif choice in ['south','main room','down','downstairs','back']:
            return main_room
        # they want to go to other rooms
...
def bathroom():
    ...
    while True:
        ...
        elif choice in ['east','main room','back']:
            return main_room
        # they want to go to other rooms
...
def kitchen():
    ...
    while True:
        ...
        # they don't know where they are
            ...
            print('You are already here.')
        # they want to go to the main room
        elif choice in ['west','main room','back']:
            return main_room
        # they want to go to other rooms
